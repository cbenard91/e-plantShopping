        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={{display: 'flex', justifyContent: 'space-between', width: '1100px'}}>
                    <button onClick={handlePlantsClick} style={{color: 'white', fontSize: '30px'}}>Plants</button>
                    <button onClick={handleCartClick} style={{color: 'white', fontSize: '30px'}}>
                        <label style={{zIndex:1, position:"fixed", fontSize:"1.5rem", cursor:"pointer"}}>{totalItems()}</label>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                            <circle cx="80" cy="216" r="12" fill="none"></circle>
                            <circle cx="184" cy="216" r="12" fill="none"></circle>
